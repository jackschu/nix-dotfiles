...
;; '(flycheck-clangcheck-build-path "PATH")
 '(flycheck-disabled-checkers nil)
;; '(flycheck-eslint-args "-c PATH")
;; '(flycheck-javascript-eslint-executable "PATH")
...
;;       (file "~/Documents/jacks_org/template.org") :empty-lines-before
;;       1)
;;      ("m" "Meeting" entry (file "~/Documents/jacks_org/notes.org")
;;       (file "~/Documents/jacks_org/template_meeting.org")
;;       :empty-lines-before 1)
;;      ("n" "Notif task" entry (file "~/Documents/jacks_org/notes.org")
;;       (file "~/Documents/jacks_org/template_notifs.org")
;;       :empty-lines-before 1)
;;      ("r" "Review Task" entry (file "~/Documents/jacks_org/notes.org")
;;       (file "~/Documents/jacks_org/template_review.org")
;;       :empty-lines-before 1)))
 ...
 '(pulsar-iterations 2)
 ;; This directory is created by home-manager (see emacs.nix)
 '(temporary-file-directory "~/.cache/emacs/")
 '(terraform-indent-level 4)
 '(tide-completion-fuzzy t)
 '(tide-server-max-response-length 204800)
;; '(tide-tscompiler-executable "PATH")
;; '(tide-tsserver-executable "PATH")
